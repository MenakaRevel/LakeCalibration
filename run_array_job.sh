...
MetWA='KLING_GUPTA_DEVIATION'                         # Evaluation metric for WA - water area #KLING_GUPTA_DEVIATION
ObsTypes='Obs_WL_SY0'                                 # Observation types according to coloumns in finca_cat.csv # Obs_SF_IS  Obs_WL_IS Obs_WA_RS1 Obs_WA_RS4 Obs_WA_SY1, {Obs_WA_SY0: all lake area}, {Obs_SF_SY: all Q}, {Obs_WL_SY0: all lake levels}
