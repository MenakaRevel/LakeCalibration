...
ObsTypes='Obs_WA_SY0'                                 # Observation types according to coloumns in finca_cat.csv # Obs_SF_IS  Obs_WL_IS Obs_WA_RS1 Obs_WA_RS4 Obs_WA_SY1 {Obs_WA_SY0: all lake area}, {Obs_SF_SY: 02KB001 Q}, {Obs_WL_SY0: all lake levels}
constrains='False'                                    # Constrain for Q bias  Q_Bias, False
ObsDir='/scratch/menaka/SytheticLakeObs/output/obs0b' # observation folder #'/scratch/menaka/SytheticLakeObs/output/obs0b' '/projects/def-btolson/menaka/LakeCalibration/OstrichRaven/RavenInput/obs', '/project/def-btolson/menaka/LakeCalibration/obs_real'
#===============================================================
