...
CalIndCW='All'                                        # Calibrate individual crest width parameters {True|False|All} -> All:  calibrate all CW without considering number of Observations
