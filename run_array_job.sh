...
ObsTypes='Obs_WA_SY1'                                 # Observation types according to coloumns in finca_cat.csv # Obs_SF_IS  Obs_WL_IS Obs_WA_RS1 Obs_WA_RS4 Obs_WA_SY1 Obs_WA_SY0 Obs_SF_SY Obs_WL_SY0
