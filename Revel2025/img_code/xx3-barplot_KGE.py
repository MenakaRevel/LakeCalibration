...
if not logscale:
    ...
    percentiles = np.percentile(filtered_gdf['DrainArea'], range(0,100+1, 10)) #[0, 25, 50, 75, 100])
    ...
    percentiles_log = np.percentile(filtered_gdf['log_DrainArea'], range(0, 100 + 1, 10))
